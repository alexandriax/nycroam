...
function part(geo: THREE.BufferGeometry, id: number, color: number, tint = 0): THREE.BufferGeometry {
...
export function buildPedestrianGeometry(): THREE.BufferGeometry {
  const pieces = [
    part(taper(0, 1.21, 0, .255, .19, .54, .58, 1), 0, 0xffffff, 1),
  ...
  for (const side of [-1, 1]) {
    ...
    pieces.push(
      part(taper(.008, .67, side * .105, .103, .077, .40, .84, 1), leg, 0x526073, .22),
      part(taper(.005, .335, side * .11, .078, .056, .32, .9, 1), leg, 0x424c5c, .22),
      part(sphere(.07, .125, side * .11, .17, .079, .079, 8, 4), leg, 0x292a2c),
      part(box(.07, .07, side * .11, .27, .026, .15), leg, 0xbdbcb3),
      part(taper(0, 1.295, side * .269, .082, .065, .30, .94, 1, 6), arm, 0xffffff, 1),
      part(taper(.022, 1.03, side * .288, .064, .047, .25, 1, 1, 6), arm, 0xffffff, 1),
      part(taper(.022, .917, side * .288, .049, .049, .026, 1, 1, 6), arm, 0xd5d0c5, .3),
    );
  }
  return merge(pieces);
}
export function buildPedestrianSkinGeometry(): THREE.BufferGeometry {
  ...
  for (const side of [-1, 1]) pieces.push(
    ...
    part(sphere(.033, .865, side * .29, .044, .071, .037, 6, 4), side < 0 ? 3 : 4, 0xffffff, 1),
  );
  return merge(pieces);
}
